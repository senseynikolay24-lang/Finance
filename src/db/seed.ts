...
// Категориальная палитра для графиков: 8 различимых оттенков (проверено на
// CVD-безопасность), а не только красные тона — иначе донат-диаграммы
// расходов сливаются в одно красное пятно.
const PALETTE = [
  '#2a78d6', // синий
  '#1baf7a', // бирюзовый
  '#eda100', // жёлтый
  '#008300', // зелёный
  '#4a3aa7', // фиолетовый
  '#E5383B', // красный (фирменный акцент)
  '#e87ba4', // розовый
  '#eb6834', // оранжевый
];
